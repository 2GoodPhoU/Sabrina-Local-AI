...
class Event:
    ...
    def __str__(self) -> str:
        ...
        event_type_name = self.event_type.name if isinstance(self.event_type, Enum) else str(self.event_type)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        event_type_name = self.event_type.name if isinstance(self.event_type, Enum) else str(self.event_type)
        priority_name = self.priority.name if isinstance(self.priority, Enum) else str(self.priority)
...
class EventBus:
    ...
    def unregister_handler(self, handler_id: str) -> bool:
        ...
        if handler.event_types:
            for event_type in handler.event_types:
                if event_type in self.handlers_by_type and handler_id in self.handlers_by_type[event_type]:
