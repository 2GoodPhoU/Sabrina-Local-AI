...
class ErrorHandler:
    ...
    def log_error(self, 
                 ...
                 should_raise: bool = False) -> Dict[str, Any]:
        """
        ...
        self._update_error_stats(error_type, module_name, severity, category, error_info)
    ...
    def log_warning(self, 
        ...
        # Create log message
        log_message = f"{context + ': ' if context else ''}{message} [{file_name}:{line_number}]"
        logger.warning(log_message)
        ...
        # Update statistics
        self._update_error_stats("WARNING", module_name, ErrorSeverity.WARNING, category, warning_info)
        
        return warning_info
    
    def register_recovery_function(self, 
                                 error_type: str, 
                                 category: ErrorCategory, 
    ...
    def try_with_recovery(self, 
                        operation: Callable, 
                        recovery_func: Callable = None,
                        context: str = "",
                        severity: ErrorSeverity = ErrorSeverity.ERROR,
                        category: ErrorCategory = ErrorCategory.UNKNOWN) -> Any:
        """
