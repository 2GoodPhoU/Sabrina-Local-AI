...
def install_python_dependencies(pip_path, args):
    ...
    if args.gpu:
        ...
        optional_packages.extend(["torch==2.0.0+cu118", "torchvision==0.15.1+cu118", "-f", "https://download.pytorch.org/whl/torch_stable.html"])
...
def setup_configuration():
    ...
    if not os.path.exists(config_file):
        ...
        with open(config_file, "w") as f:
            f.write("""# Sabrina AI Configuration
