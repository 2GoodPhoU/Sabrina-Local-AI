...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Sabrina AI Simple Integration Example")
    parser.add_argument("--demo", choices=["voice", "vision", "automation", "all"], 
                       default="all", help="Which component to demonstrate")
...
def init_voice_client(event_bus=None):
    ...
    try:
        ...
        if connection_successful:
            ...
            logger.warning("Voice API connection failed - voice synthesis will not work")
...
def init_automation_component():
    ...
    try:
        ...
        try:
            ...
            logger.warning("Actions module not found, automation features will be unavailable")
            return None
        ...
        if pyautogui_available:
            ...
            logger.info("Automation component initialized in simulation mode (PyAutoGUI not available)")
            COMPONENTS_AVAILABLE["automation"] = True  # Still mark as available for demo purposes
...
def demonstrate_vision(vision_core):
    ...
    try:
        ...
        if capture_result and os.path.exists(capture_result):
            ...
            # OCR test
            if hasattr(vision_core, 'vision_ocr') and hasattr(vision_core.vision_ocr, 'run_ocr'):
                ...
                if ocr_text:
                    ...
                    print("⚠ OCR returned no text - either no text in image or OCR not working")
            else:
    ...
    try:
        ...
        if image_path and os.path.exists(image_path):
            ...
            if ocr_text:
                ...
                voice_client.speak(f"I can see text on your screen. Here's what I found: {trimmed_text}")
            ...
            voice_client.speak("I tried to capture your screen but encountered a problem.")
            print("✗ Screen capture failed")
        ...
        if automation:
            ...
            voice_client.speak("I'll now move the mouse cursor to position 200, 200 on your screen.")
...
def main():
    ...
    if args.demo == "all":
        ...
        can_demonstrate_integration = (
            COMPONENTS_AVAILABLE["voice"] and 
            COMPONENTS_AVAILABLE["vision"]
        )
