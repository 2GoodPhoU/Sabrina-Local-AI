...
def setup_system_tray(parent):
    ...
    try:
        ...
        tray_icon_path = tray_config.get(
            "tray_icon_path", os.path.join(ASSETS_FOLDER, "static.png")
        )
...
def show_tray_notification(
    tray_icon, title, message, icon=QSystemTrayIcon.Information, duration=5000
):
