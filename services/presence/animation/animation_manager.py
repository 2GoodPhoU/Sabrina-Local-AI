...
class AnimationManager:
    ...
    def load_animations(self):
        ...
        logger.debug(f"Loaded {len(self.animations)} animations in {load_duration:.2f}ms")
    ...
    def queue_animation(self, state, priority=None):
        ...
        if self.current_state:
            ...
            if state_priority > current_priority:
                ...
                logger.debug(f"Queued high-priority animation: {state} (priority {state_priority})")
                return True
    ...
    def save_animation_mapping(self, filename="animation_mapping.json"):
        ...
        try:
            ...
            ErrorHandler.log_error(e, f"{self.__class__.__name__}.save_animation_mapping")
            return False
    ...
    def load_animation_mapping(self, filename="animation_mapping.json"):
        ...
        try:
            ...
            ErrorHandler.log_error(e, f"{self.__class__.__name__}.load_animation_mapping")
            return False
    ...
    def set_animation_on_label(self, state, label):
        ...
        try:
            ...
            ErrorHandler.log_error(e, f"{self.__class__.__name__}.set_animation_on_label")
            return False
